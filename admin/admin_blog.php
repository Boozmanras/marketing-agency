...
if(in_array($file_ext, $extensions) == false){
  array_push($errors, "Sorry This File Extension is not allow. Please try with this ext.(JPG,PNG,JPEG,gif)");
}
...
if(count($errors)==0){
 move_uploaded_file($tmp_thumbnail,"../images/thumbnail/$thumb");
   $query1=mysqli_query($conn,"insert into blogs(date,title,des,thumbnail,author,status)values('$date','$title','$des','$thumb','$author','yes')") or die(mysqli_error($conn));
   if ($query1) {
   
$_SESSION['success']="blog has been successful posted";
...
?>
		...
		<nav class="py-2">
				<ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item">
                      <a href="blog.php">Admin blogs management</a></li>				
<li class="breadcrumb-item active">write blog
</li>				
              </ol>
          </nav>
      ...
      <div class="auth-content">
          <div class="card">
              <div class="card-body text-center">
                  ...
                  <h6 class="mb-4 text-muted">write blog then post</h6>
                  <form autocomplete="off" action="admin_blog.php"  method="POST" enctype="multipart/form-data" name="categoryform">
