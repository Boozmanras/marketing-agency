...
$check_ip = mysqli_query($conn, "select userip from pageview where page='$id' and userip='$user_ip' and viewer='$k'");}
...
$insertview = mysqli_query($conn, "insert into pageview values('','$id','$user_ip','$name','$k','10')"); 
...
echo mysqli_num_rows($show); ?></b> views</p>
...
<div class="container">
                  ...
                  <?php
                  $like_query = mysqli_query($conn,"SELECT * FROM likes WHERE blogid = '$id' AND username = '$username'");
                  $count = mysqli_num_rows($like_query);

                  $like_count = mysqli_query($conn,"SELECT * FROM likes WHERE blogid = $id");
