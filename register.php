...
if(!empty($ref)) {
setcookie("refer", $ref, time() + (86400*30),'/');
        ...
        <div class="auth-content">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <h6 class="mb-4 text-muted"><?php echo $_COOKIE["refer"];?>Create new account</h6>
...
<div class="form-group text-left">
                            ...
                            <input type="text" class="form-control"  value="  <?php 	if(!isset($_COOKIE["refer"])){
