...
<link rel="stylesheet" type="text/css" href="assets/css/loader.css">
    ...
    <title>Signup | fidelity Investments co</title>
...
<option value="">Select package</option>
    <option value="bronze">bronze(kes 300)</option>
    <option value="silver">silver(kes 600)</option>
    <option value="gold">Gold(kes 1000)</option>
    <option value="platinum">platinum(kes 2000)</option>
</select>
