...
include("connections/db.php");
  ...
  $query= mysqli_query($db,"SELECT * FROM blogs WHERE id= '$id' AND author='$username'") or die(mysql_error());
...
<li class="breadcrumb-item"><a href="blog.php">my blogs</a></li>
...
echo "<script>alert('your blog has been successfully updated!');</script>";
