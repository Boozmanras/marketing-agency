...
$query2 = mysqli_query($conn,"SELECT * FROM blogs WHERE status='yes' ORDER BY id desc LIMIT 5"); 
...
; ?>" class="img img-thumbnail" style="height:400px;"></a></p>
               ...
               <a href="author.php?author=<?php echo $row['id']; ?>"><i class="fas fa-user-edit"></i><?php echo $row['author']; ?></a>
