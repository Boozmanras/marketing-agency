 <?php
  session_start();
include('../server.php');
if(isset($_SESSION['username'], $_SESSION['password'],$_SESSION['country'])){                                                                                 $username =   $_SESSION['username']    ;    
                                              $password=$_SESSION['password'];
$country = $_SESSION['country'];
}

elseif(isset($_COOKIE["username"],$_COOKIE['password'],$_COOKIE['country'])){
