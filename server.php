...
if(empty($country)){
  array_push($errors,"please select your country".$country);
}
...
if($payment_method == 'mpesa'){
	...
	$query = "INSERT INTO users (username, email, password, tel,country,status,ref,package)       

VALUES('$username', '$email', '$password', '$phone','$country','no','$ref','$package')";
...
setcookie("country",$country,time() + (86400),"/php/");
// 86400 = 1 day
...
array_push($errors,"Credentials mismatch");
